...
import { User, Mail, Lock, MapPin, Briefcase, DollarSign, FileText, Code, ExternalLink, Linkedin, Upload } from 'lucide-react';
...
return (
    ...
    <div className="container mx-auto max-w-4xl">
        ...
        <p className="text-base-content/70 text-lg">Join us and start tracking your job applications</p>
        </div>
        ...
        <div className="card-body p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <label className="label">
                    ...
                    Job Applying For <span className="text-error">*</span>
                    </span>
                </label>
                <input
                    type="text"
                    ...
                    className="input input-bordered"
                    value={formData.job_applying_for}
                    onChange={handleChange}
                    required
                />
                </div>
                ...
                <label className="label">
                    ...
                    Location Preference <span className="text-error">*</span>
                    </span>
                </label>
                <input
                    type="text"
            ...
            {/* Row 5: Salary Expectation */}
            <div className="form-control mb-6">
                <label className="label">
                <span className="label-text font-semibold">
                    <DollarSign className="inline mr-1" size={16} />
                    Salary Expectation (PHP) <span className="text-error">*</span>
                </span>
                </label>
                <input
                type="number"
            ...
            <div className="form-control mb-4">
                <label className="label">
                <span className="label-text font-semibold">
                    <Code className="inline mr-1" size={16} />
                    Skills
                </span>
                </label>
                <input
