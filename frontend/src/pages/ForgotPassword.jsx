...
const ForgotPasswordPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.error('Error sending reset email. Please check your email/username.');
                ...
                <div className="card bg-base-100 shadow-2xl">
                    <div className="card-body p-8">
                        <div className="form-control mb-6">
                            ...
                            <input type="text" name="emailOrUsername" placeholder="Enter your email or username" className="input input-bordered input-lg" value={identifier} onChange={(e) => setIdentifier(e.target.value)} required />
                                <label className="label">
